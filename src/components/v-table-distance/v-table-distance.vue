<template>
  <div class="v-table">
    ...
    <div class="v-table__header mt-4">
      ...
      <p
        :class="{ icon__selected: IS_SORTING_CITY }"
      ...
      <p
        :class="{ icon__selected: IS_SORTING_NUMBER }"
        class="d-flex justify-start  text-center dist_city"
      >
        Количество
      ...
      <p
        :class="{ icon__selected: IS_SORTING_DISTANCE }"
        class="d-flex justify-start  text-center dist_city"
      >
        Расстояние
...
export default {
  ...
  methods: {
    ...
    pageClick(page) {
      ...
      if (this.IS_FILTERING_CITY) {
        if (
          this.IS_SORTING_CITY &&
          !this.IS_SORTING_NUMBER &&
          !this.IS_SORTING_DISTANCE
        ) {
          this.GET_DATA_CITY_FROM_API({
            isFilteringCity: this.IS_FILTERING_CITY,
            isSortingCity: true,
